...
#[doc = "Possible values of the field `CHMOD`"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum CHMODR {
...
impl CHMODR {
    ...
    #[doc(hidden)]
    #[inline]
    pub fn _from(value: bool) -> CHMODR {
        match value {
            false => CHMODR::CHMOD_0,
            true => CHMODR::CHMOD_1,
        }
    }
...
#[doc = "Values that can be written to the field `CHMOD`"]
pub enum CHMODW {
    #[doc = "TDM mode, transmit data pins are tri-stated when slots are masked or channels are disabled."]
    CHMOD_0,
    #[doc = "Output mode, transmit data pins are never tri-stated and will output zero when slots are masked or channels are disabled."]
...
impl<'a> _CHMODW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
    pub fn variant(self, variant: CHMODW) -> &'a mut W {
        {
            self.bit(variant._bits())
        }
    }
    ...
    pub fn chmod_0(self) -> &'a mut W {
        self.variant(CHMODW::CHMOD_0)
    }
    #[doc = "Output mode, transmit data pins are never tri-stated and will output zero when slots are masked or channels are disabled."]
    #[inline]
    pub fn chmod_1(self) -> &'a mut W {
        self.variant(CHMODW::CHMOD_1)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
