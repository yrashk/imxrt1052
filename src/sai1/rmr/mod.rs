...
#[doc = "Possible values of the field `RWM`"]
...
impl RWMR {
    ...
    pub fn bits(&self) -> u32 {
        match *self {
            RWMR::RWM_0 => 0,
            RWMR::RWM_1 => 1,
            RWMR::_Reserved(bits) => bits,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
    pub fn _from(value: u32) -> RWMR {
        match value {
            0 => RWMR::RWM_0,
            1 => RWMR::RWM_1,
            i => RWMR::_Reserved(i),
...
#[doc = "Values that can be written to the field `RWM`"]
pub enum RWMW {
    #[doc = "Word N is enabled."]
    RWM_0,
    #[doc = "Word N is masked."]
...
impl<'a> _RWMW<'a> {
    ...
    #[inline]
    pub fn variant(self, variant: RWMW) -> &'a mut W {
        unsafe { self.bits(variant._bits()) }
    }
    #[doc = "Word N is enabled."]
    #[inline]
    pub fn rwm_0(self) -> &'a mut W {
        self.variant(RWMW::RWM_0)
    }
    #[doc = "Word N is masked."]
    #[inline]
    pub fn rwm_1(self) -> &'a mut W {
        self.variant(RWMW::RWM_1)
    }
