...
#[doc = "Values that can be written to the field `SAEE`"]
pub enum SAEEW {
...
impl<'a> _SAEEW<'a> {
    ...
    #[inline]
    pub fn variant(self, variant: SAEEW) -> &'a mut W {
        {
    ...
    pub fn saee_0(self) -> &'a mut W {
        self.variant(SAEEW::SAEE_0)
    }
    #[doc = "no description available"]
    #[inline]
    pub fn saee_1(self) -> &'a mut W {
        self.variant(SAEEW::SAEE_1)
    }
...
impl W {
    ...
    #[inline]
    pub fn seei(&mut self) -> _SEEIW {
        _SEEIW { w: self }
    }
    #[doc = "Bit 6 - Sets All Enable Error Interrupts"]
    #[inline]
    pub fn saee(&mut self) -> _SAEEW {
        _SAEEW { w: self }
    }
