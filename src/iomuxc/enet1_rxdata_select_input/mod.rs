...
impl super::ENET1_RXDATA_SELECT_INPUT {
...
impl DAISYR {
    ...
    pub fn bit(&self) -> bool {
        match *self {
            DAISYR::GPIO_EMC_19_ALT3 => false,
            DAISYR::GPIO_B1_05_ALT3 => true,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
...
impl DAISYW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            DAISYW::GPIO_EMC_19_ALT3 => false,
            DAISYW::GPIO_B1_05_ALT3 => true,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _DAISYW<'a> {
    ...
    pub fn gpio_emc_19_alt3(self) -> &'a mut W {
        self.variant(DAISYW::GPIO_EMC_19_ALT3)
    }
    #[doc = "Selecting Pad: GPIO_B1_05 for Mode: ALT3"]
    #[inline]
    pub fn gpio_b1_05_alt3(self) -> &'a mut W {
        self.variant(DAISYW::GPIO_B1_05_ALT3)
    }
