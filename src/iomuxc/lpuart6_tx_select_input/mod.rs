...
impl super::LPUART6_TX_SELECT_INPUT {
...
impl DAISYR {
    ...
    pub fn bit(&self) -> bool {
        match *self {
            DAISYR::GPIO_EMC_25_ALT2 => false,
            DAISYR::GPIO_AD_B0_02_ALT2 => true,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
...
impl DAISYW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            DAISYW::GPIO_EMC_25_ALT2 => false,
            DAISYW::GPIO_AD_B0_02_ALT2 => true,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _DAISYW<'a> {
    ...
    pub fn gpio_emc_25_alt2(self) -> &'a mut W {
        self.variant(DAISYW::GPIO_EMC_25_ALT2)
    }
    #[doc = "Selecting Pad: GPIO_AD_B0_02 for Mode: ALT2"]
    #[inline]
    pub fn gpio_ad_b0_02_alt2(self) -> &'a mut W {
        self.variant(DAISYW::GPIO_AD_B0_02_ALT2)
    }
