...
impl super::LPSPI3_PCS0_SELECT_INPUT {
...
impl DAISYR {
    ...
    pub fn bit(&self) -> bool {
        match *self {
            DAISYR::GPIO_AD_B0_03_ALT7 => false,
            DAISYR::GPIO_AD_B1_12_ALT2 => true,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    ...
    pub fn _from(value: bool) -> DAISYR {
        match value {
            false => DAISYR::GPIO_AD_B0_03_ALT7,
            true => DAISYR::GPIO_AD_B1_12_ALT2,
        }
    }
    #[doc = "Checks if the value of the field is `GPIO_AD_B0_03_ALT7`"]
    #[inline]
    pub fn is_gpio_ad_b0_03_alt7(&self) -> bool {
        *self == DAISYR::GPIO_AD_B0_03_ALT7
    }
    #[doc = "Checks if the value of the field is `GPIO_AD_B1_12_ALT2`"]
    #[inline]
    pub fn is_gpio_ad_b1_12_alt2(&self) -> bool {
        *self == DAISYR::GPIO_AD_B1_12_ALT2
    }
}
...
impl DAISYW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            DAISYW::GPIO_AD_B0_03_ALT7 => false,
            DAISYW::GPIO_AD_B1_12_ALT2 => true,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _DAISYW<'a> {
    ...
    pub fn gpio_ad_b0_03_alt7(self) -> &'a mut W {
        self.variant(DAISYW::GPIO_AD_B0_03_ALT7)
    }
    #[doc = "Selecting Pad: GPIO_AD_B1_12 for Mode: ALT2"]
    #[inline]
    pub fn gpio_ad_b1_12_alt2(self) -> &'a mut W {
        self.variant(DAISYW::GPIO_AD_B1_12_ALT2)
    }
