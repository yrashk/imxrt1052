...
impl super::LPI2C2_SCL_SELECT_INPUT {
...
impl DAISYR {
    ...
    pub fn bit(&self) -> bool {
        match *self {
            DAISYR::GPIO_SD_B1_11_ALT3 => false,
            DAISYR::GPIO_B0_04_ALT2 => true,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
...
impl DAISYW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            DAISYW::GPIO_SD_B1_11_ALT3 => false,
            DAISYW::GPIO_B0_04_ALT2 => true,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _DAISYW<'a> {
    ...
    pub fn gpio_sd_b1_11_alt3(self) -> &'a mut W {
        self.variant(DAISYW::GPIO_SD_B1_11_ALT3)
    }
    #[doc = "Selecting Pad: GPIO_B0_04 for Mode: ALT2"]
    #[inline]
    pub fn gpio_b0_04_alt2(self) -> &'a mut W {
        self.variant(DAISYW::GPIO_B0_04_ALT2)
    }
