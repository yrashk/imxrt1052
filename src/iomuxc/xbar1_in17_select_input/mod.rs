...
impl super::XBAR1_IN17_SELECT_INPUT {
...
impl DAISYR {
    ...
    pub fn bits(&self) -> u8 {
        match *self {
            DAISYR::GPIO_EMC_08_ALT3 => 0,
            DAISYR::GPIO_AD_B0_03_ALT1 => 1,
            DAISYR::GPIO_AD_B0_05_ALT6 => 2,
            DAISYR::GPIO_B1_03_ALT1 => 3,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    ...
    pub fn _from(value: u8) -> DAISYR {
        match value {
            0 => DAISYR::GPIO_EMC_08_ALT3,
            1 => DAISYR::GPIO_AD_B0_03_ALT1,
            2 => DAISYR::GPIO_AD_B0_05_ALT6,
            3 => DAISYR::GPIO_B1_03_ALT1,
            _ => unreachable!(),
        }
    }
...
impl DAISYW {
    ...
    pub fn _bits(&self) -> u8 {
        match *self {
            DAISYW::GPIO_EMC_08_ALT3 => 0,
            DAISYW::GPIO_AD_B0_03_ALT1 => 1,
            DAISYW::GPIO_AD_B0_05_ALT6 => 2,
            DAISYW::GPIO_B1_03_ALT1 => 3,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _DAISYW<'a> {
    ...
    pub fn gpio_emc_08_alt3(self) -> &'a mut W {
        self.variant(DAISYW::GPIO_EMC_08_ALT3)
    }
    #[doc = "Selecting Pad: GPIO_AD_B0_03 for Mode: ALT1"]
    #[inline]
    pub fn gpio_ad_b0_03_alt1(self) -> &'a mut W {
        self.variant(DAISYW::GPIO_AD_B0_03_ALT1)
    }
    #[doc = "Selecting Pad: GPIO_AD_B0_05 for Mode: ALT6"]
    #[inline]
    pub fn gpio_ad_b0_05_alt6(self) -> &'a mut W {
        self.variant(DAISYW::GPIO_AD_B0_05_ALT6)
    }
    #[doc = "Selecting Pad: GPIO_B1_03 for Mode: ALT1"]
    #[inline]
    pub fn gpio_b1_03_alt1(self) -> &'a mut W {
        self.variant(DAISYW::GPIO_B1_03_ALT1)
    }
