...
impl super::LPI2C3_SCL_SELECT_INPUT {
...
impl DAISYR {
    ...
    pub fn bits(&self) -> u8 {
        match *self {
            DAISYR::GPIO_EMC_22_ALT2 => 0,
            DAISYR::GPIO_SD_B0_00_ALT2 => 1,
            DAISYR::GPIO_AD_B1_07_ALT1 => 2,
    ...
    pub fn _from(value: u8) -> DAISYR {
        match value {
            0 => DAISYR::GPIO_EMC_22_ALT2,
            1 => DAISYR::GPIO_SD_B0_00_ALT2,
            2 => DAISYR::GPIO_AD_B1_07_ALT1,
            i => DAISYR::_Reserved(i),
        }
    }
    #[doc = "Checks if the value of the field is `GPIO_EMC_22_ALT2`"]
    #[inline]
    pub fn is_gpio_emc_22_alt2(&self) -> bool {
        *self == DAISYR::GPIO_EMC_22_ALT2
    }
    #[doc = "Checks if the value of the field is `GPIO_SD_B0_00_ALT2`"]
    #[inline]
    pub fn is_gpio_sd_b0_00_alt2(&self) -> bool {
        *self == DAISYR::GPIO_SD_B0_00_ALT2
    }
    #[doc = "Checks if the value of the field is `GPIO_AD_B1_07_ALT1`"]
    #[inline]
    pub fn is_gpio_ad_b1_07_alt1(&self) -> bool {
        *self == DAISYR::GPIO_AD_B1_07_ALT1
    }
}
...
impl DAISYW {
    ...
    pub fn _bits(&self) -> u8 {
        match *self {
            DAISYW::GPIO_EMC_22_ALT2 => 0,
            DAISYW::GPIO_SD_B0_00_ALT2 => 1,
            DAISYW::GPIO_AD_B1_07_ALT1 => 2,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _DAISYW<'a> {
    ...
    #[doc = "Selecting Pad: GPIO_EMC_22 for Mode: ALT2"]
    #[inline]
    pub fn gpio_emc_22_alt2(self) -> &'a mut W {
        self.variant(DAISYW::GPIO_EMC_22_ALT2)
    }
    #[doc = "Selecting Pad: GPIO_SD_B0_00 for Mode: ALT2"]
    #[inline]
    pub fn gpio_sd_b0_00_alt2(self) -> &'a mut W {
        self.variant(DAISYW::GPIO_SD_B0_00_ALT2)
    }
    #[doc = "Selecting Pad: GPIO_AD_B1_07 for Mode: ALT1"]
    #[inline]
    pub fn gpio_ad_b1_07_alt1(self) -> &'a mut W {
        self.variant(DAISYW::GPIO_AD_B1_07_ALT1)
    }
