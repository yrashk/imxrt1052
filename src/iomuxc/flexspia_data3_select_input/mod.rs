...
impl super::FLEXSPIA_DATA3_SELECT_INPUT {
...
impl DAISYR {
    ...
    pub fn bit(&self) -> bool {
        match *self {
            DAISYR::GPIO_SD_B1_11_ALT1 => false,
            DAISYR::GPIO_AD_B1_10_ALT0 => true,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
...
impl DAISYW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            DAISYW::GPIO_SD_B1_11_ALT1 => false,
            DAISYW::GPIO_AD_B1_10_ALT0 => true,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _DAISYW<'a> {
    ...
    pub fn gpio_sd_b1_11_alt1(self) -> &'a mut W {
        self.variant(DAISYW::GPIO_SD_B1_11_ALT1)
    }
    #[doc = "Selecting Pad: GPIO_AD_B1_10 for Mode: ALT0"]
    #[inline]
    pub fn gpio_ad_b1_10_alt0(self) -> &'a mut W {
        self.variant(DAISYW::GPIO_AD_B1_10_ALT0)
    }
