...
impl super::FLEXPWM1_PWMA0_SELECT_INPUT {
...
impl DAISYR {
    ...
    pub fn bit(&self) -> bool {
        match *self {
            DAISYR::GPIO_EMC_23_ALT1 => false,
            DAISYR::GPIO_SD_B0_00_ALT1 => true,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    ...
    pub fn _from(value: bool) -> DAISYR {
        match value {
            false => DAISYR::GPIO_EMC_23_ALT1,
            true => DAISYR::GPIO_SD_B0_00_ALT1,
        }
    }
    #[doc = "Checks if the value of the field is `GPIO_EMC_23_ALT1`"]
    #[inline]
    pub fn is_gpio_emc_23_alt1(&self) -> bool {
        *self == DAISYR::GPIO_EMC_23_ALT1
    }
    #[doc = "Checks if the value of the field is `GPIO_SD_B0_00_ALT1`"]
    #[inline]
    pub fn is_gpio_sd_b0_00_alt1(&self) -> bool {
        *self == DAISYR::GPIO_SD_B0_00_ALT1
    }
}
...
impl DAISYW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            DAISYW::GPIO_EMC_23_ALT1 => false,
            DAISYW::GPIO_SD_B0_00_ALT1 => true,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _DAISYW<'a> {
    ...
    #[doc = "Selecting Pad: GPIO_EMC_23 for Mode: ALT1"]
    #[inline]
    pub fn gpio_emc_23_alt1(self) -> &'a mut W {
        self.variant(DAISYW::GPIO_EMC_23_ALT1)
    }
    #[doc = "Selecting Pad: GPIO_SD_B0_00 for Mode: ALT1"]
    #[inline]
    pub fn gpio_sd_b0_00_alt1(self) -> &'a mut W {
        self.variant(DAISYW::GPIO_SD_B0_00_ALT1)
    }
