...
impl super::LPI2C3_SDA_SELECT_INPUT {
...
impl DAISYR {
    ...
    pub fn bits(&self) -> u8 {
        match *self {
            DAISYR::GPIO_EMC_21_ALT2 => 0,
            DAISYR::GPIO_SD_B0_01_ALT2 => 1,
            DAISYR::GPIO_AD_B1_06_ALT1 => 2,
    ...
    pub fn _from(value: u8) -> DAISYR {
        match value {
            0 => DAISYR::GPIO_EMC_21_ALT2,
            1 => DAISYR::GPIO_SD_B0_01_ALT2,
            2 => DAISYR::GPIO_AD_B1_06_ALT1,
...
impl DAISYW {
    ...
    pub fn _bits(&self) -> u8 {
        match *self {
            DAISYW::GPIO_EMC_21_ALT2 => 0,
            DAISYW::GPIO_SD_B0_01_ALT2 => 1,
            DAISYW::GPIO_AD_B1_06_ALT1 => 2,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _DAISYW<'a> {
    ...
    pub fn gpio_emc_21_alt2(self) -> &'a mut W {
        self.variant(DAISYW::GPIO_EMC_21_ALT2)
    }
    #[doc = "Selecting Pad: GPIO_SD_B0_01 for Mode: ALT2"]
    #[inline]
    pub fn gpio_sd_b0_01_alt2(self) -> &'a mut W {
        self.variant(DAISYW::GPIO_SD_B0_01_ALT2)
    }
    #[doc = "Selecting Pad: GPIO_AD_B1_06 for Mode: ALT1"]
    #[inline]
    pub fn gpio_ad_b1_06_alt1(self) -> &'a mut W {
        self.variant(DAISYW::GPIO_AD_B1_06_ALT1)
    }
