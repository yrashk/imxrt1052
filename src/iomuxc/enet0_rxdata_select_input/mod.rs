...
impl super::ENET0_RXDATA_SELECT_INPUT {
...
impl DAISYR {
    ...
    pub fn bit(&self) -> bool {
        match *self {
            DAISYR::GPIO_EMC_20_ALT3 => false,
            DAISYR::GPIO_B1_04_ALT3 => true,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    ...
    pub fn _from(value: bool) -> DAISYR {
        match value {
            false => DAISYR::GPIO_EMC_20_ALT3,
            true => DAISYR::GPIO_B1_04_ALT3,
        }
    }
    #[doc = "Checks if the value of the field is `GPIO_EMC_20_ALT3`"]
    #[inline]
    pub fn is_gpio_emc_20_alt3(&self) -> bool {
        *self == DAISYR::GPIO_EMC_20_ALT3
    }
    #[doc = "Checks if the value of the field is `GPIO_B1_04_ALT3`"]
    #[inline]
    pub fn is_gpio_b1_04_alt3(&self) -> bool {
        *self == DAISYR::GPIO_B1_04_ALT3
    }
}
...
impl DAISYW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            DAISYW::GPIO_EMC_20_ALT3 => false,
            DAISYW::GPIO_B1_04_ALT3 => true,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _DAISYW<'a> {
    ...
    pub fn gpio_emc_20_alt3(self) -> &'a mut W {
        self.variant(DAISYW::GPIO_EMC_20_ALT3)
    }
    #[doc = "Selecting Pad: GPIO_B1_04 for Mode: ALT3"]
    #[inline]
    pub fn gpio_b1_04_alt3(self) -> &'a mut W {
        self.variant(DAISYW::GPIO_B1_04_ALT3)
    }
