...
impl super::FLEXSPIA_DATA0_SELECT_INPUT {
...
impl DAISYR {
    ...
    pub fn bit(&self) -> bool {
        match *self {
            DAISYR::GPIO_SD_B1_08_ALT1 => false,
            DAISYR::GPIO_AD_B1_13_ALT0 => true,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    ...
    pub fn _from(value: bool) -> DAISYR {
        match value {
            false => DAISYR::GPIO_SD_B1_08_ALT1,
            true => DAISYR::GPIO_AD_B1_13_ALT0,
        }
    }
    #[doc = "Checks if the value of the field is `GPIO_SD_B1_08_ALT1`"]
    #[inline]
    pub fn is_gpio_sd_b1_08_alt1(&self) -> bool {
        *self == DAISYR::GPIO_SD_B1_08_ALT1
    }
    #[doc = "Checks if the value of the field is `GPIO_AD_B1_13_ALT0`"]
    #[inline]
    pub fn is_gpio_ad_b1_13_alt0(&self) -> bool {
        *self == DAISYR::GPIO_AD_B1_13_ALT0
    }
}
...
impl DAISYW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            DAISYW::GPIO_SD_B1_08_ALT1 => false,
            DAISYW::GPIO_AD_B1_13_ALT0 => true,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _DAISYW<'a> {
    ...
    pub fn gpio_sd_b1_08_alt1(self) -> &'a mut W {
        self.variant(DAISYW::GPIO_SD_B1_08_ALT1)
    }
    #[doc = "Selecting Pad: GPIO_AD_B1_13 for Mode: ALT0"]
    #[inline]
    pub fn gpio_ad_b1_13_alt0(self) -> &'a mut W {
        self.variant(DAISYW::GPIO_AD_B1_13_ALT0)
    }
