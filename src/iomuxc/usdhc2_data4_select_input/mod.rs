...
impl super::USDHC2_DATA4_SELECT_INPUT {
...
impl DAISYR {
    ...
    pub fn bit(&self) -> bool {
        match *self {
            DAISYR::GPIO_SD_B1_08_ALT0 => false,
            DAISYR::GPIO_AD_B1_12_ALT6 => true,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
...
impl DAISYW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            DAISYW::GPIO_SD_B1_08_ALT0 => false,
            DAISYW::GPIO_AD_B1_12_ALT6 => true,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _DAISYW<'a> {
    ...
    pub fn gpio_sd_b1_08_alt0(self) -> &'a mut W {
        self.variant(DAISYW::GPIO_SD_B1_08_ALT0)
    }
    #[doc = "Selecting Pad: GPIO_AD_B1_12 for Mode: ALT6"]
    #[inline]
    pub fn gpio_ad_b1_12_alt6(self) -> &'a mut W {
        self.variant(DAISYW::GPIO_AD_B1_12_ALT6)
    }
