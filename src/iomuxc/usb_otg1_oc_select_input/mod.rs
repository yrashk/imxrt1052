...
impl super::USB_OTG1_OC_SELECT_INPUT {
...
impl DAISYR {
    ...
    pub fn bit(&self) -> bool {
        match *self {
            DAISYR::GPIO_AD_B0_03_ALT3 => false,
            DAISYR::GPIO_AD_B1_03_ALT0 => true,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    ...
    pub fn _from(value: bool) -> DAISYR {
        match value {
            false => DAISYR::GPIO_AD_B0_03_ALT3,
            true => DAISYR::GPIO_AD_B1_03_ALT0,
        }
    }
    #[doc = "Checks if the value of the field is `GPIO_AD_B0_03_ALT3`"]
    #[inline]
    pub fn is_gpio_ad_b0_03_alt3(&self) -> bool {
        *self == DAISYR::GPIO_AD_B0_03_ALT3
    }
    #[doc = "Checks if the value of the field is `GPIO_AD_B1_03_ALT0`"]
    #[inline]
    pub fn is_gpio_ad_b1_03_alt0(&self) -> bool {
        *self == DAISYR::GPIO_AD_B1_03_ALT0
    }
}
...
impl DAISYW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            DAISYW::GPIO_AD_B0_03_ALT3 => false,
            DAISYW::GPIO_AD_B1_03_ALT0 => true,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _DAISYW<'a> {
    ...
    pub fn gpio_ad_b0_03_alt3(self) -> &'a mut W {
        self.variant(DAISYW::GPIO_AD_B0_03_ALT3)
    }
    #[doc = "Selecting Pad: GPIO_AD_B1_03 for Mode: ALT0"]
    #[inline]
    pub fn gpio_ad_b1_03_alt0(self) -> &'a mut W {
        self.variant(DAISYW::GPIO_AD_B1_03_ALT0)
    }
