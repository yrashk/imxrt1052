...
impl DAISYR {
    ...
    pub fn bits(&self) -> u8 {
        match *self {
            DAISYR::GPIO_SD_B1_09_ALT3 => 0,
            DAISYR::GPIO_AD_B1_15_ALT3 => 1,
            DAISYR::GPIO_B1_03_ALT3 => 2,
    ...
    pub fn _from(value: u8) -> DAISYR {
        match value {
            0 => DAISYR::GPIO_SD_B1_09_ALT3,
            1 => DAISYR::GPIO_AD_B1_15_ALT3,
            2 => DAISYR::GPIO_B1_03_ALT3,
...
impl DAISYW {
    ...
    pub fn _bits(&self) -> u8 {
        match *self {
            DAISYW::GPIO_SD_B1_09_ALT3 => 0,
            DAISYW::GPIO_AD_B1_15_ALT3 => 1,
            DAISYW::GPIO_B1_03_ALT3 => 2,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _DAISYW<'a> {
    ...
    pub fn gpio_sd_b1_09_alt3(self) -> &'a mut W {
        self.variant(DAISYW::GPIO_SD_B1_09_ALT3)
    }
    #[doc = "Selecting Pad: GPIO_AD_B1_15 for Mode: ALT3"]
    #[inline]
    pub fn gpio_ad_b1_15_alt3(self) -> &'a mut W {
        self.variant(DAISYW::GPIO_AD_B1_15_ALT3)
    }
    #[doc = "Selecting Pad: GPIO_B1_03 for Mode: ALT3"]
    #[inline]
    pub fn gpio_b1_03_alt3(self) -> &'a mut W {
        self.variant(DAISYW::GPIO_B1_03_ALT3)
    }
