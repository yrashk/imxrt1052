...
impl super::LPSPI2_SDO_SELECT_INPUT {
...
impl DAISYR {
    ...
    pub fn bit(&self) -> bool {
        match *self {
            DAISYR::GPIO_SD_B1_08_ALT4 => false,
            DAISYR::GPIO_EMC_02_ALT2 => true,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    ...
    pub fn _from(value: bool) -> DAISYR {
        match value {
            false => DAISYR::GPIO_SD_B1_08_ALT4,
            true => DAISYR::GPIO_EMC_02_ALT2,
        }
    }
    #[doc = "Checks if the value of the field is `GPIO_SD_B1_08_ALT4`"]
    #[inline]
    pub fn is_gpio_sd_b1_08_alt4(&self) -> bool {
        *self == DAISYR::GPIO_SD_B1_08_ALT4
    }
    #[doc = "Checks if the value of the field is `GPIO_EMC_02_ALT2`"]
    #[inline]
    pub fn is_gpio_emc_02_alt2(&self) -> bool {
        *self == DAISYR::GPIO_EMC_02_ALT2
    }
}
...
impl DAISYW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            DAISYW::GPIO_SD_B1_08_ALT4 => false,
            DAISYW::GPIO_EMC_02_ALT2 => true,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _DAISYW<'a> {
    ...
    pub fn gpio_sd_b1_08_alt4(self) -> &'a mut W {
        self.variant(DAISYW::GPIO_SD_B1_08_ALT4)
    }
    #[doc = "Selecting Pad: GPIO_EMC_02 for Mode: ALT2"]
    #[inline]
    pub fn gpio_emc_02_alt2(self) -> &'a mut W {
        self.variant(DAISYW::GPIO_EMC_02_ALT2)
    }
