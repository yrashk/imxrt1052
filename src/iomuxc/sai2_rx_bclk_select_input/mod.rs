...
impl super::SAI2_RX_BCLK_SELECT_INPUT {
...
impl DAISYR {
    ...
    pub fn bit(&self) -> bool {
        match *self {
            DAISYR::GPIO_EMC_10_ALT2 => false,
            DAISYR::GPIO_AD_B0_06_ALT3 => true,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    ...
    pub fn _from(value: bool) -> DAISYR {
        match value {
            false => DAISYR::GPIO_EMC_10_ALT2,
            true => DAISYR::GPIO_AD_B0_06_ALT3,
        }
    }
    #[doc = "Checks if the value of the field is `GPIO_EMC_10_ALT2`"]
    #[inline]
    pub fn is_gpio_emc_10_alt2(&self) -> bool {
        *self == DAISYR::GPIO_EMC_10_ALT2
    }
    #[doc = "Checks if the value of the field is `GPIO_AD_B0_06_ALT3`"]
    #[inline]
    pub fn is_gpio_ad_b0_06_alt3(&self) -> bool {
        *self == DAISYR::GPIO_AD_B0_06_ALT3
    }
}
...
impl DAISYW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            DAISYW::GPIO_EMC_10_ALT2 => false,
            DAISYW::GPIO_AD_B0_06_ALT3 => true,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _DAISYW<'a> {
    ...
    #[doc = "Selecting Pad: GPIO_EMC_10 for Mode: ALT2"]
    #[inline]
    pub fn gpio_emc_10_alt2(self) -> &'a mut W {
        self.variant(DAISYW::GPIO_EMC_10_ALT2)
    }
    #[doc = "Selecting Pad: GPIO_AD_B0_06 for Mode: ALT3"]
    #[inline]
    pub fn gpio_ad_b0_06_alt3(self) -> &'a mut W {
        self.variant(DAISYW::GPIO_AD_B0_06_ALT3)
    }
