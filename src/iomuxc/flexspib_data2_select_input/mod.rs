...
impl super::FLEXSPIB_DATA2_SELECT_INPUT {
...
impl DAISYR {
    ...
    pub fn bit(&self) -> bool {
        match *self {
            DAISYR::GPIO_SD_B1_01_ALT1 => false,
            DAISYR::GPIO_AD_B1_05_ALT0 => true,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
...
impl DAISYW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            DAISYW::GPIO_SD_B1_01_ALT1 => false,
            DAISYW::GPIO_AD_B1_05_ALT0 => true,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _DAISYW<'a> {
    ...
    pub fn gpio_sd_b1_01_alt1(self) -> &'a mut W {
        self.variant(DAISYW::GPIO_SD_B1_01_ALT1)
    }
    #[doc = "Selecting Pad: GPIO_AD_B1_05 for Mode: ALT0"]
    #[inline]
    pub fn gpio_ad_b1_05_alt0(self) -> &'a mut W {
        self.variant(DAISYW::GPIO_AD_B1_05_ALT0)
    }
