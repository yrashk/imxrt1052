...
impl super::XBAR1_IN15_SELECT_INPUT {
...
impl DAISYR {
    ...
    pub fn bit(&self) -> bool {
        match *self {
            DAISYR::GPIO_AD_B0_01_ALT1 => false,
            DAISYR::GPIO_B1_01_ALT1 => true,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
...
impl DAISYW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            DAISYW::GPIO_AD_B0_01_ALT1 => false,
            DAISYW::GPIO_B1_01_ALT1 => true,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _DAISYW<'a> {
    ...
    pub fn gpio_ad_b0_01_alt1(self) -> &'a mut W {
        self.variant(DAISYW::GPIO_AD_B0_01_ALT1)
    }
    #[doc = "Selecting Pad: GPIO_B1_01 for Mode: ALT1"]
    #[inline]
    pub fn gpio_b1_01_alt1(self) -> &'a mut W {
        self.variant(DAISYW::GPIO_B1_01_ALT1)
    }
