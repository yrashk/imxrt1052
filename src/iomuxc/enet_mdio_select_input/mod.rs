...
impl super::ENET_MDIO_SELECT_INPUT {
...
impl DAISYR {
    ...
    pub fn bits(&self) -> u8 {
        match *self {
            DAISYR::GPIO_AD_B1_05_ALT1 => 0,
            DAISYR::GPIO_EMC_41_ALT4 => 1,
            DAISYR::GPIO_B1_15_ALT0 => 2,
    ...
    pub fn _from(value: u8) -> DAISYR {
        match value {
            0 => DAISYR::GPIO_AD_B1_05_ALT1,
            1 => DAISYR::GPIO_EMC_41_ALT4,
            2 => DAISYR::GPIO_B1_15_ALT0,
...
impl DAISYW {
    ...
    pub fn _bits(&self) -> u8 {
        match *self {
            DAISYW::GPIO_AD_B1_05_ALT1 => 0,
            DAISYW::GPIO_EMC_41_ALT4 => 1,
            DAISYW::GPIO_B1_15_ALT0 => 2,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _DAISYW<'a> {
    ...
    pub fn gpio_ad_b1_05_alt1(self) -> &'a mut W {
        self.variant(DAISYW::GPIO_AD_B1_05_ALT1)
    }
    #[doc = "Selecting Pad: GPIO_EMC_41 for Mode: ALT4"]
    #[inline]
    pub fn gpio_emc_41_alt4(self) -> &'a mut W {
        self.variant(DAISYW::GPIO_EMC_41_ALT4)
    }
    #[doc = "Selecting Pad: GPIO_B1_15 for Mode: ALT0"]
    #[inline]
    pub fn gpio_b1_15_alt0(self) -> &'a mut W {
        self.variant(DAISYW::GPIO_B1_15_ALT0)
    }
