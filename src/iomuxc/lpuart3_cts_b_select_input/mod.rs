...
impl super::LPUART3_CTS_B_SELECT_INPUT {
...
impl DAISYR {
    ...
    pub fn bit(&self) -> bool {
        match *self {
            DAISYR::GPIO_EMC_15_ALT2 => false,
            DAISYR::GPIO_AD_B1_04_ALT2 => true,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
...
impl DAISYW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            DAISYW::GPIO_EMC_15_ALT2 => false,
            DAISYW::GPIO_AD_B1_04_ALT2 => true,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _DAISYW<'a> {
    ...
    pub fn gpio_emc_15_alt2(self) -> &'a mut W {
        self.variant(DAISYW::GPIO_EMC_15_ALT2)
    }
    #[doc = "Selecting Pad: GPIO_AD_B1_04 for Mode: ALT2"]
    #[inline]
    pub fn gpio_ad_b1_04_alt2(self) -> &'a mut W {
        self.variant(DAISYW::GPIO_AD_B1_04_ALT2)
    }
