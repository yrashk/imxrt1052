...
impl super::CSI_HSYNC_SELECT_INPUT {
...
impl DAISYR {
    ...
    pub fn bits(&self) -> u8 {
        match *self {
            DAISYR::GPIO_AD_B0_15_ALT4 => 0,
            DAISYR::GPIO_AD_B1_07_ALT4 => 1,
            DAISYR::GPIO_B1_14_ALT2 => 2,
    ...
    pub fn _from(value: u8) -> DAISYR {
        match value {
            0 => DAISYR::GPIO_AD_B0_15_ALT4,
            1 => DAISYR::GPIO_AD_B1_07_ALT4,
            2 => DAISYR::GPIO_B1_14_ALT2,
...
impl DAISYW {
    ...
    pub fn _bits(&self) -> u8 {
        match *self {
            DAISYW::GPIO_AD_B0_15_ALT4 => 0,
            DAISYW::GPIO_AD_B1_07_ALT4 => 1,
            DAISYW::GPIO_B1_14_ALT2 => 2,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _DAISYW<'a> {
    ...
    pub fn gpio_ad_b0_15_alt4(self) -> &'a mut W {
        self.variant(DAISYW::GPIO_AD_B0_15_ALT4)
    }
    #[doc = "Selecting Pad: GPIO_AD_B1_07 for Mode: ALT4"]
    #[inline]
    pub fn gpio_ad_b1_07_alt4(self) -> &'a mut W {
        self.variant(DAISYW::GPIO_AD_B1_07_ALT4)
    }
    #[doc = "Selecting Pad: GPIO_B1_14 for Mode: ALT2"]
    #[inline]
    pub fn gpio_b1_14_alt2(self) -> &'a mut W {
        self.variant(DAISYW::GPIO_B1_14_ALT2)
    }
