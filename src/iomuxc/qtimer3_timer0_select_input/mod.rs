...
impl super::QTIMER3_TIMER0_SELECT_INPUT {
...
impl DAISYR {
    ...
    pub fn bits(&self) -> u8 {
        match *self {
            DAISYR::GPIO_EMC_15_ALT4 => 0,
            DAISYR::GPIO_AD_B1_00_ALT1 => 1,
            DAISYR::GPIO_B0_06_ALT1 => 2,
    ...
    pub fn _from(value: u8) -> DAISYR {
        match value {
            0 => DAISYR::GPIO_EMC_15_ALT4,
            1 => DAISYR::GPIO_AD_B1_00_ALT1,
            2 => DAISYR::GPIO_B0_06_ALT1,
...
impl DAISYW {
    ...
    pub fn _bits(&self) -> u8 {
        match *self {
            DAISYW::GPIO_EMC_15_ALT4 => 0,
            DAISYW::GPIO_AD_B1_00_ALT1 => 1,
            DAISYW::GPIO_B0_06_ALT1 => 2,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _DAISYW<'a> {
    ...
    pub fn gpio_emc_15_alt4(self) -> &'a mut W {
        self.variant(DAISYW::GPIO_EMC_15_ALT4)
    }
    #[doc = "Selecting Pad: GPIO_AD_B1_00 for Mode: ALT1"]
    #[inline]
    pub fn gpio_ad_b1_00_alt1(self) -> &'a mut W {
        self.variant(DAISYW::GPIO_AD_B1_00_ALT1)
    }
    #[doc = "Selecting Pad: GPIO_B0_06 for Mode: ALT1"]
    #[inline]
    pub fn gpio_b0_06_alt1(self) -> &'a mut W {
        self.variant(DAISYW::GPIO_B0_06_ALT1)
    }
