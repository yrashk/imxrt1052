...
impl super::FLEXPWM1_PWMB0_SELECT_INPUT {
...
impl DAISYR {
    ...
    pub fn bit(&self) -> bool {
        match *self {
            DAISYR::GPIO_EMC_24_ALT1 => false,
            DAISYR::GPIO_SD_B0_01_ALT1 => true,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
...
impl DAISYW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            DAISYW::GPIO_EMC_24_ALT1 => false,
            DAISYW::GPIO_SD_B0_01_ALT1 => true,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _DAISYW<'a> {
    ...
    pub fn gpio_emc_24_alt1(self) -> &'a mut W {
        self.variant(DAISYW::GPIO_EMC_24_ALT1)
    }
    #[doc = "Selecting Pad: GPIO_SD_B0_01 for Mode: ALT1"]
    #[inline]
    pub fn gpio_sd_b0_01_alt1(self) -> &'a mut W {
        self.variant(DAISYW::GPIO_SD_B0_01_ALT1)
    }
