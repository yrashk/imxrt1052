...
impl super::USDHC1_WP_SELECT_INPUT {
...
impl DAISYR {
    ...
    pub fn bits(&self) -> u8 {
        match *self {
            DAISYR::GPIO_EMC_12_ALT3 => 0,
            DAISYR::GPIO_EMC_36_ALT6 => 1,
            DAISYR::GPIO_AD_B1_00_ALT6 => 2,
            DAISYR::GPIO_B1_13_ALT6 => 3,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    ...
    pub fn _from(value: u8) -> DAISYR {
        match value {
            0 => DAISYR::GPIO_EMC_12_ALT3,
            1 => DAISYR::GPIO_EMC_36_ALT6,
            2 => DAISYR::GPIO_AD_B1_00_ALT6,
            3 => DAISYR::GPIO_B1_13_ALT6,
            _ => unreachable!(),
        }
    }
...
impl DAISYW {
    ...
    pub fn _bits(&self) -> u8 {
        match *self {
            DAISYW::GPIO_EMC_12_ALT3 => 0,
            DAISYW::GPIO_EMC_36_ALT6 => 1,
            DAISYW::GPIO_AD_B1_00_ALT6 => 2,
            DAISYW::GPIO_B1_13_ALT6 => 3,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _DAISYW<'a> {
    ...
    pub fn gpio_emc_12_alt3(self) -> &'a mut W {
        self.variant(DAISYW::GPIO_EMC_12_ALT3)
    }
    #[doc = "Selecting Pad: GPIO_EMC_36for Mode: ALT6"]
    #[inline]
    pub fn gpio_emc_36_alt6(self) -> &'a mut W {
        self.variant(DAISYW::GPIO_EMC_36_ALT6)
    }
    #[doc = "Selecting Pad:GPIO_AD_B1_00 for Mode: ALT6"]
    #[inline]
    pub fn gpio_ad_b1_00_alt6(self) -> &'a mut W {
        self.variant(DAISYW::GPIO_AD_B1_00_ALT6)
    }
    #[doc = "Selecting Pad: GPIO_B1_13 for Mode: ALT6"]
    #[inline]
    pub fn gpio_b1_13_alt6(self) -> &'a mut W {
        self.variant(DAISYW::GPIO_B1_13_ALT6)
    }
