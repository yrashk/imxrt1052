...
impl super::CSI_DATA06_SELECT_INPUT {
...
impl DAISYR {
    ...
    pub fn bit(&self) -> bool {
        match *self {
            DAISYR::GPIO_AD_B1_11_ALT4 => false,
            DAISYR::GPIO_AD_B0_07_ALT4 => true,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    ...
    pub fn _from(value: bool) -> DAISYR {
        match value {
            false => DAISYR::GPIO_AD_B1_11_ALT4,
            true => DAISYR::GPIO_AD_B0_07_ALT4,
        }
    }
    #[doc = "Checks if the value of the field is `GPIO_AD_B1_11_ALT4`"]
    #[inline]
    pub fn is_gpio_ad_b1_11_alt4(&self) -> bool {
        *self == DAISYR::GPIO_AD_B1_11_ALT4
    }
    #[doc = "Checks if the value of the field is `GPIO_AD_B0_07_ALT4`"]
    #[inline]
    pub fn is_gpio_ad_b0_07_alt4(&self) -> bool {
        *self == DAISYR::GPIO_AD_B0_07_ALT4
    }
}
...
impl DAISYW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            DAISYW::GPIO_AD_B1_11_ALT4 => false,
            DAISYW::GPIO_AD_B0_07_ALT4 => true,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _DAISYW<'a> {
    ...
    #[doc = "Selecting Pad: GPIO_AD_B1_11 for Mode: ALT4"]
    #[inline]
    pub fn gpio_ad_b1_11_alt4(self) -> &'a mut W {
        self.variant(DAISYW::GPIO_AD_B1_11_ALT4)
    }
    #[doc = "Selecting Pad: GPIO_AD_B0_07 for Mode: ALT4"]
    #[inline]
    pub fn gpio_ad_b0_07_alt4(self) -> &'a mut W {
        self.variant(DAISYW::GPIO_AD_B0_07_ALT4)
    }
