...
impl W {
    ...
    #[doc = "Bits 0:3 - Weight of QoS"]
    #[inline]
    pub fn wqos(&mut self) -> _WQOSW {
        _WQOSW { w: self }
    }
    #[doc = "Bits 4:7 - Weight of Aging"]
    #[inline]
    pub fn wage(&mut self) -> _WAGEW {
        _WAGEW { w: self }
    }
    #[doc = "Bits 8:15 - Weight of Page Hit"]
    #[inline]
    pub fn wph(&mut self) -> _WPHW {
        _WPHW { w: self }
    }
    #[doc = "Bits 16:23 - Weight of Read/Write switch"]
    #[inline]
