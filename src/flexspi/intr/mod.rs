...
#[doc = r" Proxy"]
pub struct _IPCMDDONEW<'a> {
    w: &'a mut W,
}
impl<'a> _IPCMDDONEW<'a> {
...
#[doc = r" Proxy"]
pub struct _AHBCMDERRW<'a> {
    w: &'a mut W,
}
impl<'a> _AHBCMDERRW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
#[doc = r" Proxy"]
pub struct _SCKSTOPBYRDW<'a> {
    w: &'a mut W,
}
impl<'a> _SCKSTOPBYRDW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
#[doc = r" Proxy"]
pub struct _SCKSTOPBYWRW<'a> {
    w: &'a mut W,
}
impl<'a> _SCKSTOPBYWRW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
#[doc = r" Proxy"]
pub struct _AHBBUSTIMEOUTW<'a> {
    w: &'a mut W,
}
impl<'a> _AHBBUSTIMEOUTW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
#[doc = r" Proxy"]
pub struct _SEQTIMEOUTW<'a> {
    w: &'a mut W,
}
impl<'a> _SEQTIMEOUTW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl W {
    ...
    #[doc = "Bit 0 - IP triggered Command Sequences Execution finished interrupt. This interrupt is also generated when there is IPCMDGE or IPCMDERR interrupt generated."]
    #[inline]
    pub fn ipcmddone(&mut self) -> _IPCMDDONEW {
        _IPCMDDONEW { w: self }
    }
    #[doc = "Bit 1 - IP triggered Command Sequences Grant Timeout interrupt."]
    #[inline]
    pub fn ipcmdge(&mut self) -> _IPCMDGEW {
        _IPCMDGEW { w: self }
    }
    #[doc = "Bit 2 - AHB triggered Command Sequences Grant Timeout interrupt."]
    #[inline]
    pub fn ahbcmdge(&mut self) -> _AHBCMDGEW {
        _AHBCMDGEW { w: self }
    }
    #[doc = "Bit 3 - IP triggered Command Sequences Error Detected interrupt. When an error detected for IP command, this command will be ignored and not executed at all."]
    #[inline]
    pub fn ipcmderr(&mut self) -> _IPCMDERRW {
        _IPCMDERRW { w: self }
    }
    #[doc = "Bit 4 - AHB triggered Command Sequences Error Detected interrupt. When an error detected for AHB command, this command will be ignored and not executed at all."]
    #[inline]
    pub fn ahbcmderr(&mut self) -> _AHBCMDERRW {
        _AHBCMDERRW { w: self }
    }
    #[doc = "Bit 5 - IP RX FIFO watermark available interrupt."]
    #[inline]
    pub fn iprxwa(&mut self) -> _IPRXWAW {
        _IPRXWAW { w: self }
    }
    #[doc = "Bit 6 - IP TX FIFO watermark empty interrupt."]
    #[inline]
    pub fn iptxwe(&mut self) -> _IPTXWEW {
        _IPTXWEW { w: self }
    }
    #[doc = "Bit 8 - SCK is stopped during command sequence because Async RX FIFO full interrupt."]
    #[inline]
    pub fn sckstopbyrd(&mut self) -> _SCKSTOPBYRDW {
        _SCKSTOPBYRDW { w: self }
    }
    #[doc = "Bit 9 - SCK is stopped during command sequence because Async TX FIFO empty interrupt."]
    #[inline]
    pub fn sckstopbywr(&mut self) -> _SCKSTOPBYWRW {
        _SCKSTOPBYWRW { w: self }
    }
    #[doc = "Bit 10 - AHB Bus timeout interrupt.Refer Interrupts chapter for more details."]
    #[inline]
    pub fn ahbbustimeout(&mut self) -> _AHBBUSTIMEOUTW {
        _AHBBUSTIMEOUTW { w: self }
    }
    #[doc = "Bit 11 - Sequence execution timeout interrupt."]
    #[inline]
    pub fn seqtimeout(&mut self) -> _SEQTIMEOUTW {
        _SEQTIMEOUTW { w: self }
    }
}
