...
impl super::USB_OTG1_PHY_CTRL_0 {
...
impl UTMI_CLK_VLDR {
    ...
    pub fn bit(&self) -> bool {
        match *self {
            ...
            UTMI_CLK_VLDR::UTMI_CLK_VLD_1 => true,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    ...
    pub fn _from(value: bool) -> UTMI_CLK_VLDR {
        match value {
            ...
            true => UTMI_CLK_VLDR::UTMI_CLK_VLD_1,
        }
    }
    ...
    pub fn is_utmi_clk_vld_1(&self) -> bool {
        *self == UTMI_CLK_VLDR::UTMI_CLK_VLD_1
    }
}
...
impl UTMI_CLK_VLDW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            ...
            UTMI_CLK_VLDW::UTMI_CLK_VLD_1 => true,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _UTMI_CLK_VLDW<'a> {
    ...
    pub fn utmi_clk_vld_1(self) -> &'a mut W {
        self.variant(UTMI_CLK_VLDW::UTMI_CLK_VLD_1)
    }
