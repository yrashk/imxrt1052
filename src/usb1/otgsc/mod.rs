...
#[doc = r" Proxy"]
pub struct _STATUS_1MSW<'a> {
    w: &'a mut W,
}
impl<'a> _STATUS_1MSW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl R {
    ...
    #[inline]
    pub fn status_1ms(&self) -> STATUS_1MSR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 21;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
impl W {
    ...
    #[doc = "Bit 21 - 1 millisecond timer Interrupt Status - Read/Write to Clear"]
    #[inline]
    pub fn status_1ms(&mut self) -> _STATUS_1MSW {
        _STATUS_1MSW { w: self }
    }
    #[doc = "Bit 22 - Data Pulse Interrupt Status - Read/Write to Clear"]
    #[inline]
    ...
    #[doc = "Bit 29 - 1 millisecond timer Interrupt Enable - Read/Write"]
    #[inline]
    pub fn en_1ms(&mut self) -> _EN_1MSW {
        _EN_1MSW { w: self }
    }
    #[doc = "Bit 30 - Data Pulse Interrupt Enable"]
    #[inline]
