...
impl R {
    ...
    #[inline]
    pub fn lfifo_count(&self) -> LFIFO_COUNTR {
        let bits = {
            const MASK: u16 = 511;
            const OFFSET: u8 = 0;
    ...
    #[inline]
    pub fn txfifo_empty(&self) -> TXFIFO_EMPTYR {
        let bits = {
    ...
    #[inline]
    pub fn txfifo_full(&self) -> TXFIFO_FULLR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 27;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
    pub fn lfifo_empty(&self) -> LFIFO_EMPTYR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 28;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
    pub fn lfifo_full(&self) -> LFIFO_FULLR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 29;
            ((self.bits >> OFFSET) & MASK as u32) != 0
