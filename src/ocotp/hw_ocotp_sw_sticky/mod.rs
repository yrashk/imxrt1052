...
pub struct BLOCK_DTCP_KEYR {
    bits: bool,
}
impl BLOCK_DTCP_KEYR {
...
#[doc = r" Proxy"]
pub struct _BLOCK_DTCP_KEYW<'a> {
    w: &'a mut W,
}
impl<'a> _BLOCK_DTCP_KEYW<'a> {
...
impl R {
    ...
    #[doc = "Bit 0 - Shadow register read and OTP read lock for DTCP_KEY region"]
    #[inline]
    pub fn block_dtcp_key(&self) -> BLOCK_DTCP_KEYR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 0;
            ((self.bits >> OFFSET) & MASK as u32) != 0
        };
        BLOCK_DTCP_KEYR { bits }
    }
...
impl W {
    ...
    #[doc = "Bit 0 - Shadow register read and OTP read lock for DTCP_KEY region"]
    #[inline]
    pub fn block_dtcp_key(&mut self) -> _BLOCK_DTCP_KEYW {
        _BLOCK_DTCP_KEYW { w: self }
    }
    #[doc = "Bit 1 - Shadow register write and OTP write lock for SRK_REVOKE region"]
    #[inline]
