...
impl STOP_MODE_CONFIGR {
    ...
    pub fn is_standby(&self) -> bool {
        *self == STOP_MODE_CONFIGR::STANDBY
    }
...
impl<'a> _STOP_MODE_CONFIGW<'a> {
    ...
    pub fn standby(self) -> &'a mut W {
        self.variant(STOP_MODE_CONFIGW::STANDBY)
    }
    #[doc = "STOP (lower power)"]
    #[inline]
