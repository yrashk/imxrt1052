...
impl R {
    ...
    #[doc = "Bits 0:6 - This field controls the PLL loop divider"]
    #[inline]
    ...
    #[doc = "Bit 13 - Enable the clock output."]
    #[inline]
...
impl W {
    ...
    #[doc = "Bit 19 - Reserved"]
    #[inline]
    pub fn pll_sel(&mut self) -> _PLL_SELW {
        _PLL_SELW { w: self }
    }
}
