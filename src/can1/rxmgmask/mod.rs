...
#[doc = "Possible values of the field `MG`"]
...
impl MGR {
    ...
    pub fn bits(&self) -> u32 {
        match *self {
            MGR::MG_0 => 0,
            MGR::MG_1 => 1,
            MGR::_Reserved(bits) => bits,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
    pub fn _from(value: u32) -> MGR {
        match value {
            0 => MGR::MG_0,
            1 => MGR::MG_1,
            i => MGR::_Reserved(i),
...
#[doc = "Values that can be written to the field `MG`"]
pub enum MGW {
    #[doc = "the corresponding bit in the filter is \"don't care\""]
    MG_0,
    #[doc = "The corresponding bit in the filter is checked against the one received"]
...
impl<'a> _MGW<'a> {
    ...
    #[inline]
    pub fn variant(self, variant: MGW) -> &'a mut W {
        unsafe { self.bits(variant._bits()) }
    }
    #[doc = "the corresponding bit in the filter is \"don't care\""]
    #[inline]
    pub fn mg_0(self) -> &'a mut W {
        self.variant(MGW::MG_0)
    }
    #[doc = "The corresponding bit in the filter is checked against the one received"]
    #[inline]
    pub fn mg_1(self) -> &'a mut W {
        self.variant(MGW::MG_1)
    }
